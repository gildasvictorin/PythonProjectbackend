...
Revision ID: c677ec4f766c
Revises: cde3e2ed4c59
Create Date: 2026-07-30 19:33:49.505797
...
revision: str = 'c677ec4f766c'
down_revision: Union[str, Sequence[str], None] = 'cde3e2ed4c59'
...
def upgrade() -> None:
    ...
    sa.Column('created_id', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    op.add_column('events', sa.Column('created_id', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    ...
    op.add_column('users', sa.Column('created_id', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('events', 'created_id')
